...
- **En construcción:** —
- **Bloqueado / pendiente:** PR develop → master pendiente de merge; PR #24 feature/new_ui_design → develop pendiente de merge
- **Próximo hito:** Merge PR #24 → develop → master
