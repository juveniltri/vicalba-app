  ...
  test: {
    ...
    coverage: {
      ...
      thresholds: {
        ...
        'src/lib/docker/**': { branches: 100, functions: 100, lines: 100, statements: 100 },
        'src/lib/traefik/**': { branches: 100, functions: 100, lines: 100, statements: 100 },
        'src/lib/schemas/**': { branches: 100, functions: 100, lines: 100, statements: 100 },
